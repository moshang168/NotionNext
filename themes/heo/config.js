const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://moshang.eu.org' },
    { title: '访问文档中心获取更多帮助', url: 'https://moshang168.eu.org' }
  ],
  ...
  HEO_HERO_TITLE_5: '何须多虑盈亏事，人生小满胜万全.',
  HEO_HERO_TITLE_LINK: 'https://moshang.eu.org',
  // 英雄区遮罩文字
  ...
  HEO_INFO_CARD_URL2: 'https://github.com/moshang168',
  HEO_INFO_CARD_ICON2: 'fab fa-github',
  HEO_INFO_CARD_ICON_ORCID: 'fab fa-orcid',
  HEO_INFO_CARD_URL3: 'https://moshang168.eu.org',
